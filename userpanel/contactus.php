...
$subjecttext = $message = "";
$subjecttext_err = $message_err = "";

// Processing form data when form is submitted
if($_SERVER["REQUEST_METHOD"] == "POST"){

    // Check input errors before sending email
    if(empty($subjecttext_err) && empty($message_err)){
    ...
    echo "<div class='alert alert-danger' role='alert'>Failed to send you request Please try again.</div>";
    }
    }
    }
    }
...
?>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="name" type="text" id="name" placeholder="<?php echo $username; ?>" disabled>
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <input name="email" type="text" id="phone" placeholder="<?php echo $email; ?>" disabled>
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
